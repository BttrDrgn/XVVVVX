...
#ifdef _XBOX
	baseDir = "D:\\";		//Games are mounted to the D drive when launched. Any new folders or files
	userDir = "D:\\user";	//added to the directory are then copied over to the games folder.
#else
