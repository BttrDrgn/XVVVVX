...
void allocateFlavorText()
{
	flavors.push_back("Now with more bugs!");
	flavors.push_back("Oh no! Oh nevermind.");
	flavors.push_back("!@#$%^&*()_+");
	flavors.push_back("VV? V, VV? V!");
	flavors.push_back("Now with less gravity!");
	flavors.push_back("Here we go again...");
	flavors.push_back("Thank you Terry Cavanagh!");
	flavors.push_back("Caution! Addicting.");
	flavors.push_back("Lorem Ipsum");
	flavors.push_back("Did you know..?");
	flavors.push_back("Flippity Doo-dah!");
	flavors.push_back("Pulp Flip-tion");
	flavors.push_back("Way of the Sine Wave Ninja!");
	flavors.push_back("Have you tried the key lime pie?");
	flavors.push_back("Also try Super Hexagon!");
	flavors.push_back("Codename XVVVVX");
}
...
void titlerender(Graphics& dwgfx, MapClass& map, Game& game, EntityClass& obj, MusicClass& music)
{
	...
	{
		allocateFlavorText();
		flavorText += flavors[floor(fRandom() * flavors.size())];
		flavors.clear(); //Free up some mem after allocating the vector
		once = false;
	}
    ...
    if (!game.menustart)
    {
        tr = (int)(164 - (vvvvvv::Utility::glow / 2) - int(fRandom() * 4));
        tg = 164 - (vvvvvv::Utility::glow / 2) - int(fRandom() * 4);
        tb = 164 - (vvvvvv::Utility::glow / 2) - int(fRandom() * 4);
		...
		dwgfx.Print(-1, temp+35, flavorText, tr, tg, tb, true);
    ...
    else
    {
        ...
        tr = map.r - (vvvvvv::Utility::glow / 4) - int(fRandom() * 4);
        tg = map.g - (vvvvvv::Utility::glow / 4) - int(fRandom() * 4);
        tb = map.b - (vvvvvv::Utility::glow / 4) - int(fRandom() * 4);
        if (tr < 0) tr = 0;
        if(tr>255) tr=255;
        if (tg < 0) tg = 0;
        if(tg>255) tg=255;
        ...
        if(game.currentmenuname=="mainmenu")
        {
            ...
            dwgfx.drawsprite((160 - 96) + 5 * 32, temp, 23, tr, tg, tb);
							...
							dwgfx.Print(-1,temp+35,"MAKE AND PLAY XBOX EDITION",tr, tg, tb, true);
#elif !defined (MAKEANDPLAY)
							dwgfx.Print(-1,temp+35,"	XBOX EDITION",tr, tg, tb, true);
#endif

            dwgfx.Print( 310 - 12 * 8, 230, "Xbox r3", tr/2, tg/2, tb/2);
        ...
        else if (game.currentmenuname == "levellist")
        {
          ...
          if(tmp>=0 && tmp < (int) ed.ListOfMetaData.size()){ // FIXME: size_t/int! -flibit
            ...
            if(game.nummenuoptions - game.currentmenuoption<=2){
              ...
              dwgfx.Print( -1, 15, ed.ListOfMetaData[tmp].title, tr, tg, tb, true);
		...
		else if (game.currentmenuname == "controller")
		{
			...
			{
				dwgfx.Print( -1, 85, "Flip is bound to: " + std::string(vvvvvv::Utility::toString(game.controllerButton_flip)) , tr, tg, tb, true);
				dwgfx.Print( -1, 95, "Enter is bound to: "  + std::string(vvvvvv::Utility::toString(game.controllerButton_map)), tr, tg, tb, true);
				dwgfx.Print( -1, 105, "Menu is bound to: " + std::string(vvvvvv::Utility::toString(game.controllerButton_esc)) , tr, tg, tb, true);
			}
		}
        ...
        else if (game.currentmenuname == "continue")
        {
            ...
            if (game.currentmenuoption == 0)
            {
                ...
                dwgfx.Print(0, 80-20, game.tele_currentarea, 25, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);
                for (int i = 0; i < 6; i++)
                {
                    dwgfx.drawcrewman(169-(3*42)+(i*42), 95-20, i, game.tele_crewstats[i], true);
                }
                dwgfx.Print(160 - 84, 132-20, game.tele_gametime, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
                dwgfx.Print(160 + 40, 132-20, vvvvvv::Utility::toWord(game.tele_trinkets), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
            ...
            else if (game.currentmenuoption == 1)
            {
                ...
                dwgfx.Print(0, 80-20, game.quick_currentarea, 25, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);
                for (int i = 0; i < 6; i++)
                {
                    dwgfx.drawcrewman(169-(3*42)+(i*42), 95-20, i, game.quick_crewstats[i], true);
                }
                dwgfx.Print(160 - 84, 132-20, game.quick_gametime, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
                dwgfx.Print(160 + 40, 132-20, vvvvvv::Utility::toWord(game.quick_trinkets), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
        ...
        else if (game.currentmenuname == "gameover" || game.currentmenuname == "gameover2")
        {
            ...
            tempstring = "You rescued " + vvvvvv::Utility::toWord(game.crewrescued()) + " crewmates";
            dwgfx.Print(0, 100, tempstring, tr, tg, tb, true);

            tempstring = "and found " + vvvvvv::Utility::toWord(game.trinkets) + " trinkets.";
        ...
        else if (game.currentmenuname == "nodeathmodecomplete" || game.currentmenuname == "nodeathmodecomplete2")
        {
            ...
            tempstring = "And you found " + vvvvvv::Utility::toWord(game.trinkets) + " trinkets.";
            dwgfx.Print(0, 110, tempstring, tr, tg, tb, true);
                 ...
                 || game.currentmenuname == "timetrialcomplete3" || game.currentmenuname == "timetrialcomplete4")
        {
            ...
            tempstring = vvvvvv::Utility::toString(game.deathcounts);
            ...
            tempstring = vvvvvv::Utility::toString(game.trinkets) + " of " + vvvvvv::Utility::toString(game.timetrialshinytarget);
            ...
            if (game.currentmenuoption == 0)
            {
                if(game.unlock[9])
                {
                    ...
                    else
                    {
                        ...
                        dwgfx.Print( 110, 75, vvvvvv::Utility::toString(game.besttrinkets[0])+"/2", tr, tg, tb);
                        dwgfx.Print( 110, 85,vvvvvv::Utility::toString(game.bestlives[0]), tr, tg, tb);
            ...
            else if (game.currentmenuoption == 1)
            {
                if(game.unlock[10])
                {
                    ...
                    else
                    {
                        ...
                        dwgfx.Print( 110, 75, vvvvvv::Utility::toString(game.besttrinkets[1])+"/4", tr, tg, tb);
                        dwgfx.Print( 110, 85, vvvvvv::Utility::toString(game.bestlives[1]), tr, tg, tb);
            ...
            else if (game.currentmenuoption == 2)
            {
                if(game.unlock[11])
                {
                    ...
                    else
                    {
                        ...
                        dwgfx.Print( 110, 75, vvvvvv::Utility::toString(game.besttrinkets[2])+"/2", tr, tg, tb);
                        dwgfx.Print( 110, 85, vvvvvv::Utility::toString(game.bestlives[2]), tr, tg, tb);
            ...
            else if (game.currentmenuoption == 3)
            {
                if(game.unlock[12])
                {
                    ...
                    else
                    {
                        ...
                        dwgfx.Print( 110, 75, vvvvvv::Utility::toString(game.besttrinkets[3])+"/5", tr, tg, tb);
                        dwgfx.Print( 110, 85, vvvvvv::Utility::toString(game.bestlives[3]), tr, tg, tb);
            ...
            else if (game.currentmenuoption == 4)
            {
                if(game.unlock[13])
                {
                    ...
                    else
                    {
                        ...
                        dwgfx.Print( 110, 75, vvvvvv::Utility::toString(game.besttrinkets[4])+"/1", tr, tg, tb);
                        dwgfx.Print( 110, 85, vvvvvv::Utility::toString(game.bestlives[4]), tr, tg, tb);
            ...
            else if (game.currentmenuoption == 5)
            {
                if(game.unlock[14])
                {
                    ...
                    else
                    {
                        ...
                        dwgfx.Print( 110, 75, vvvvvv::Utility::toString(game.besttrinkets[5])+"/1", tr, tg, tb);
                        dwgfx.Print( 110, 85, vvvvvv::Utility::toString(game.bestlives[5]), tr, tg, tb);
        ...
        {   
						...
						if(dwgfx.tempstring.length()>80){
							...
							dwgfx.Print( 280-((dwgfx.tempstring.length()-40)*8), 200, dwgfx.tempstring.substr(0,dwgfx.tempstring.length()-40), tr, tg, tb);
							dwgfx.Print( 0, 210, dwgfx.tempstring.substr(dwgfx.tempstring.length()-40,40), tr, tg, tb);
						}else{
							...
							dwgfx.Print( 280-(dwgfx.tempstring.length()*8), 210, dwgfx.tempstring, tr, tg, tb);
						}
        }
...
void gamecompleterender(Graphics& dwgfx, Game& game, EntityClass& obj, MapClass& map)
{
    ...
    tr = map.r - (vvvvvv::Utility::glow / 4) - fRandom() * 4;
    if (tr < 0) tr = 0;
    else if (tr > 255) tr = 255;

    tg = map.g - (vvvvvv::Utility::glow / 4) - fRandom() * 4;
    if (tg < 0) tg = 0;
    else if (tg > 255) tg = 255;

    tb = map.b - (vvvvvv::Utility::glow / 4) - fRandom() * 4;
    if (tb < 0) tb = 0;
    ...
    if (dwgfx.onscreen(y + game.creditposition) == 0)
    {
        for (int i = 0; i < 6; i++)
        {
            dwgfx.drawsprite((160 - 96) + i * 32, y + game.creditposition, 23, tr, tg, tb);
        }
    }

    y += 70;
    if (dwgfx.onscreen(y + game.creditposition) == 0) {
        dwgfx.bigprint( -1, y + game.creditposition, "Starring", tr, tg, tb, true, 2);
    }

    y += 30;
    static const char* starring[] = {
        "Captain Viridian",
        "Doctor Violet",
        "Professor Vitellary",
        "Officer Vermilion",
    ...
    for (int i = 0; i < 6; i++)
    {
        int pos = dwgfx.onscreen(y + (i * 30) + game.creditposition);
        if (pos == -1)
        {
            continue;
        }
    ...
    if (dwgfx.onscreen(y + game.creditposition) == 0) 
    {
        dwgfx.bigprint( -1, y + game.creditposition, "Credits", tr, tg, tb, true, 3);
    }
    ...
    if (dwgfx.onscreen(y + game.creditposition) == 0)
    {
        dwgfx.Print(40, y + game.creditposition, "Xbox Port by", tr, tg, tb);
        dwgfx.bigprint(60, y + 10 + game.creditposition, "Drgn", tr, tg, tb);
    }
    ...
    if (dwgfx.onscreen(y + game.creditposition) == 0)
    {
        dwgfx.bigprint( -1, y + game.creditposition, "Patrons", tr, tg, tb, true, 3);
    }

    y += 30;
    static const char* patrons_1[] = {
        "Anders Ekermo",
        "Andreas K|mper",
        "Anthony Burch",
        "Bennett Foddy",
    ...
    for (int i = 0; i < 17; i++)
    {
        int pos = dwgfx.onscreen(y + (i * 10) + game.creditposition);
        if (pos == -1)
        {
            continue;
        }
        ...
        dwgfx.Print(-1, y + (i * 10) + game.creditposition, patrons_1[i], tr, tg, tb, true);
    }
    
    y += 180;
    if (dwgfx.onscreen(y + game.creditposition) == 0)
    {
        dwgfx.Print(-1, y + game.creditposition, "and", tr, tg, tb, true);
    }

    y += 20;
    static const char* patrons_2[] = {
        "Adam Wendt",
        "Andreas J{rgensen",
        "}ngel Louzao Penalva",
        "Ashley Burton",
    ...
    for (int i = 0; i < 52; i++)
    {
        ...
        dwgfx.Print(-1, y + (i * 10) + game.creditposition, patrons_2[i], tr, tg, tb, true);
    }

    y += 660;
    if (dwgfx.onscreen(y + game.creditposition) == 0)
    {
        dwgfx.bigprint( -1, y + game.creditposition, "Thanks for playing!", tr, tg, tb, true, 2);
    }
...
void gamerender(Graphics& dwgfx, MapClass& map, Game& game, EntityClass& obj)
{
    ...
    if(map.extrarow==0 || (map.custommode && map.roomname!=""))
    {
        ...
        if (map.finalmode)
        {
          ...
          dwgfx.Print(5, 231, map.glitchname, 196, 196, 255 - vvvvvv::Utility::glow, true);
        }else{
          dwgfx.Print(5, 231, map.roomname, 196, 196, 255 - vvvvvv::Utility::glow, true);
        }
    }
    ...
    if (map.roomtexton)
    {
        ...
        {
            dwgfx.Print(map.roomtextx[i]*8, (map.roomtexty[i]*8), map.roomtext[i], 196, 196, 255 - vvvvvv::Utility::glow);
        }
    }

     if(map.custommode && !map.custommodeforreal){
        //Return to level editor
        dwgfx.bprint(5, 5, "[Press ENTER to return to editor]", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), false);
      }
    ...
    if (dwgfx.flipmode)
    {
        if (game.advancetext) dwgfx.bprint(5, 228, "- Press ACTION to advance text -", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
    }
    else
    {
        if (game.advancetext) dwgfx.bprint(5, 5, "- Press ACTION to advance text -", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
    }
    ...
    if (game.readytotele > 100 && !game.advancetext && game.hascontrol && !script.running && !game.intimetrial)
    {
        if(dwgfx.flipmode)
        {
            dwgfx.bprint(5, 20, "- Press ENTER to Teleport -", game.readytotele - 20 - (vvvvvv::Utility::glow / 2), game.readytotele - 20 - (vvvvvv::Utility::glow / 2), game.readytotele, true);
        }
        else
        {
            dwgfx.bprint(5, 210, "- Press ENTER to Teleport -", game.readytotele - 20 - (vvvvvv::Utility::glow / 2), game.readytotele - 20 - (vvvvvv::Utility::glow / 2), game.readytotele, true);
        }
    }
    ...
    if (game.swnmode)
    {
        if (game.swngame == 0)
        {
            tempstring = vvvvvv::Utility::timeString(game.swntimer);
            dwgfx.bigprint( -1, 20, tempstring, 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
        }
        else if (game.swngame == 1)
        {
            ...
            {
                tempstring = vvvvvv::Utility::timeString(game.swntimer);
                dwgfx.Print( 10, 10, "Current Time", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), false);
                dwgfx.bigprint( 25, 24, tempstring, 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), false, 2);
                tempstring = vvvvvv::Utility::timeString(game.swnrecord);
                dwgfx.Print( 240, 10, "Best Time", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), false);
                dwgfx.bigrprint( 300, 24, tempstring, 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), false, 2);

                switch(game.swnbestrank)
                {
                case 0:
                    dwgfx.Print( -1, 204, "Next Trophy at 5 seconds", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                case 1:
                    dwgfx.Print( -1, 204, "Next Trophy at 10 seconds", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                case 2:
                    dwgfx.Print( -1, 204, "Next Trophy at 15 seconds", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                case 3:
                    dwgfx.Print( -1, 204, "Next Trophy at 20 seconds", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                case 4:
                    dwgfx.Print( -1, 204, "Next Trophy at 30 seconds", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                case 5:
                    dwgfx.Print( -1, 204, "Next Trophy at 1 minute", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                case 6:
                    dwgfx.Print( -1, 204, "All Trophies collected!", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                    break;
                }
            }
            else if (game.swnmessage == 1)
            {
                ...
                {
                    dwgfx.Print( 240, 10, "Best Time", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), false);
                    dwgfx.bigrprint( 300, 24, tempstring, 128 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 128 - (vvvvvv::Utility::glow / 2), false, 2);

                    dwgfx.bigprint( -1, 200, "New Record!", 128 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 128 - (vvvvvv::Utility::glow / 2), true, 2);
                }
            }
            else if (game.swnmessage >= 2)
            {
                ...
                {
                    dwgfx.bigprint( -1, 200, "New Trophy!", 220 - (vvvvvv::Utility::glow), 128 - (vvvvvv::Utility::glow), 128 - (vvvvvv::Utility::glow / 2), true, 2);
                }
            }

            dwgfx.Print( 20, 228, "[Press ENTER to stop]", 160 - (vvvvvv::Utility::glow/2), 160 - (vvvvvv::Utility::glow/2), 160 - (vvvvvv::Utility::glow/2), true);
        }
        else if(game.swngame==2)
        {
            if (int(game.swndelay / 15) % 2 == 1 || game.swndelay >= 120)
            {
                if (dwgfx.flipmode)
                {
                    dwgfx.bigprint( -1, 30, "Survive for", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
                    dwgfx.bigprint( -1, 10, "60 seconds!", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
                }
                else
                {
                    dwgfx.bigprint( -1, 10, "Survive for", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
                    dwgfx.bigprint( -1, 30, "60 seconds!", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
                }
            }
        }
        else if(game.swngame==7)
        {
            if (game.swndelay >= 60)
            {
                dwgfx.bigprint( -1, 20, "SUPER GRAVITRON", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);

                tempstring = vvvvvv::Utility::timeString(game.swnrecord);
                dwgfx.Print( 240, 190, "Best Time", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
                dwgfx.bigrprint( 300, 205, tempstring, 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
            }
            else	if (int(game.swndelay / 10) % 2 == 1)
            {
                dwgfx.bigprint( -1, 20, "SUPER GRAVITRON", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 2);
                dwgfx.bigprint( -1, 200, "GO!", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 3);
            }
        }
    }
    ...
    if (game.intimetrial && dwgfx.fademode==0)
    {
        ...
        if (game.timetrialcountdown > 0)
        {
            ...
            {
                game.resetgameclock();
                if (int(game.timetrialcountdown / 4) % 2 == 0) dwgfx.bigprint( -1, 100, "Go!", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 4);
            }
            else if (game.timetrialcountdown < 60)
            {
                dwgfx.bigprint( -1, 100, "1", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 4);
            }
            else if (game.timetrialcountdown < 90)
            {
                dwgfx.bigprint( -1, 100, "2", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 4);
            }
            else if (game.timetrialcountdown < 120)
            {
                dwgfx.bigprint( -1, 100, "3", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true, 4);
            }
        }
        else
        {
            ...
            if(game.deathcounts>0)
            {
                dwgfx.bprint(56, 30,vvvvvv::Utility::toString(game.deathcounts),  196, 80, 80);
            }
            else
            {
                dwgfx.bprint(56, 30,vvvvvv::Utility::toString(game.deathcounts),  196, 196, 196);
            }
            if(game.trinkets<game.timetrialshinytarget)
            {
                dwgfx.bprint(56, 42,vvvvvv::Utility::toString(game.trinkets) + " of " +vvvvvv::Utility::toString(game.timetrialshinytarget),  196, 80, 80);
            }
            else
            {
                dwgfx.bprint(56, 42,vvvvvv::Utility::toString(game.trinkets) + " of " +vvvvvv::Utility::toString(game.timetrialshinytarget),  196, 196, 196);
            }
    ...
    //dwgfx.rprint(5, 231,vvvvvv::Utility::toString(game.coins), 255 - vvvvvv::Utility::glow/2, 255 - vvvvvv::Utility::glow/2, 196, true);
    ...
    /*
    game.test = true;
    if (game.teststring !=vvvvvv::Utility::toString(game.state)) trace(game.state);
    game.teststring =vvvvvv::Utility::toString(game.state);
    */

    //Detail entity info for debuging
    /*
    for (int i = 0; i < obj.nentity; i++) {
    	game.tempstring =vvvvvv::Utility::toString(obj.entities[i].type) +", (" +vvvvvv::Utility::toString(obj.entities[i].xp) + "," +vvvvvv::Utility::toString(obj.entities[i].yp) + ")";
    ...
    */
    ...
    /*
    game.test = true;
    game.teststring =vvvvvv::Utility::toString(int(obj.entities[obj.getplayer()].xp)) + "," +vvvvvv::Utility::toString(int(obj.entities[obj.getplayer()].yp));
    game.teststring += "   [" +vvvvvv::Utility::toString(game.roomx) + "," +vvvvvv::Utility::toString(game.roomy) + "]";
    */

    //game.test = true;
    //game.teststring = "Current room deaths: " +vvvvvv::Utility::toString(game.currentroomdeaths);

    //Special thing for loading:
    /*
    if(dwgfx.fademode==1){
      if(game.mainmenu==22){
        dwgfx.Print(5, 225, "Loading...", 196, 196, 255 - vvvvvv::Utility::glow, false);
      }
    }
    */
...
void maprender(Graphics& dwgfx, Game& game, MapClass& map, EntityClass& obj)
{
    ...
    if (temp < 2 && !map.custommode && dwgfx.fademode==0)
    {
        ...
        {
            dwgfx.Print(5, 2, "The Ship", 196, 196, 255 - vvvvvv::Utility::glow, true);
        }
        else
        {
            dwgfx.Print(5, 2, "Dimension VVVVVV", 196, 196, 255 - vvvvvv::Utility::glow, true);
        }
    }
    else
    {
      if (map.finalmode){
        map.glitchname = map.getglitchname(game.roomx, game.roomy);
        dwgfx.Print(5, 2, map.glitchname, 196, 196, 255 - vvvvvv::Utility::glow, true);
      }else{
        dwgfx.Print(5, 2, map.roomname, 196, 196, 255 - vvvvvv::Utility::glow, true);
      }
    }
    ...
    {
    case 0:
        dwgfx.Print(30 - 8, 220, "[MAP]", 196, 196, 255 - vvvvvv::Utility::glow);
        if (game.insecretlab)
        {
          ...
          if(map.customzoom==4){
            if(map.cursorstate==1){
              ...
              if (int(map.cursordelay / 15) % 2 == 0){
                dwgfx.drawrect(40 + ((game.roomx - 100) * 48) + 2+map.custommmxoff, 21 + ((game.roomy - 100) * 36) + 2+map.custommmyoff, 48 - 4, 36 - 4, 16, 245 - (vvvvvv::Utility::glow), 245 - (vvvvvv::Utility::glow));
              }
            }
          }else if(map.customzoom==2){
            if(map.cursorstate==1){
              ...
              if (int(map.cursordelay / 15) % 2 == 0){
                dwgfx.drawrect(40 + ((game.roomx - 100) * 24) + 2+map.custommmxoff, 21 + ((game.roomy - 100) * 18) + 2+map.custommmyoff, 24 - 4, 18 - 4, 16, 245 - (vvvvvv::Utility::glow), 245 - (vvvvvv::Utility::glow));
              }
            }
          }else{
            if(map.cursorstate==1){
              ...
              if (int(map.cursordelay / 15) % 2 == 0){
                dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2+map.custommmxoff, 21 + ((game.roomy - 100) * 9) + 2+map.custommmyoff, 12 - 4, 9 - 4, 16, 245 - (vvvvvv::Utility::glow), 245 - (vvvvvv::Utility::glow));
              }
            }
          }
        }
        else
        {
            ...
            if (game.roomx == 109)
            {
                ...
                /*if (map.ypos > (0.57 * (680 * 8))) {
                	...
                	dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2, 21 + i + 2, 12 - 4, 9 - 4, 16, 245 - (vvvvvv::Utility::glow * 2), 245 - (vvvvvv::Utility::glow * 2));
                }*/
                if (map.cursorstate == 0)
                {
                    map.cursordelay++;
                ...
                else if (map.cursorstate == 2)
                {
                    ...
                    if (int(map.cursordelay / 15) % 2 == 0)
                    {
                        dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2 , 21  + 2, 12 - 4, 180 - 4,16, 245 - (vvvvvv::Utility::glow), 245 - (vvvvvv::Utility::glow));
                    }
                }
            }
            else
            {
                ...
                else if (map.cursorstate == 2)
                {
                    ...
                    if (int(map.cursordelay / 15) % 2 == 0)
                    {
                        dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2, 21 + ((game.roomy - 100) * 9) + 2, 12 - 4, 9 - 4, 16, 245 - (vvvvvv::Utility::glow), 245 - (vvvvvv::Utility::glow));
                    }
                }
            }
    ...
    case 1:
        if (game.insecretlab)
        {
            ...
            dwgfx.Print(103-8, 220, "[GRAV]", 196, 196, 255 - vvvvvv::Utility::glow);
            dwgfx.Print(185-4, 220, "STATS", 64,64,64);
            dwgfx.Print(258, 220, "SAVE", 64, 64, 64);

            if (dwgfx.flipmode)
            {
                dwgfx.Print(0, 174, "SUPER GRAVITRON HIGHSCORE", 196, 196, 255 - vvvvvv::Utility::glow, true);

                tempstring = vvvvvv::Utility::timeString(game.swnrecord);
                dwgfx.Print( 240, 124, "Best Time", 196, 196, 255 - vvvvvv::Utility::glow, true);
                dwgfx.bigrprint( 300, 94, tempstring, 196, 196, 255 - vvvvvv::Utility::glow, true, 2);

                switch(game.swnbestrank)
                {
                case 0:
                    dwgfx.Print( -1, 40, "Next Trophy at 5 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 1:
                    dwgfx.Print( -1, 40, "Next Trophy at 10 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 2:
                    dwgfx.Print( -1, 40, "Next Trophy at 15 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 3:
                    dwgfx.Print( -1, 40, "Next Trophy at 20 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 4:
                    dwgfx.Print( -1, 40, "Next Trophy at 30 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 5:
                    dwgfx.Print( -1, 40, "Next Trophy at 1 minute", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 6:
                    dwgfx.Print( -1, 40, "All Trophies collected!", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                }
            }
            else
            {
                dwgfx.Print(0, 40, "SUPER GRAVITRON HIGHSCORE", 196, 196, 255 - vvvvvv::Utility::glow, true);

                tempstring = vvvvvv::Utility::timeString(game.swnrecord);
                dwgfx.Print( 240, 90, "Best Time", 196, 196, 255 - vvvvvv::Utility::glow, true);
                dwgfx.bigrprint( 300, 104, tempstring, 196, 196, 255 - vvvvvv::Utility::glow, true, 2);

                switch(game.swnbestrank)
                {
                case 0:
                    dwgfx.Print( -1, 174, "Next Trophy at 5 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 1:
                    dwgfx.Print( -1, 174, "Next Trophy at 10 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 2:
                    dwgfx.Print( -1, 174, "Next Trophy at 15 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 3:
                    dwgfx.Print( -1, 174, "Next Trophy at 20 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 4:
                    dwgfx.Print( -1, 174, "Next Trophy at 30 seconds", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 5:
                    dwgfx.Print( -1, 174, "Next Trophy at 1 minute", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                case 6:
                    dwgfx.Print( -1, 174, "All Trophies collected!", 196, 196, 255 - vvvvvv::Utility::glow, true);
                    break;
                }
            }
        }
        ...
        {
            dwgfx.Print(30, 220, "MAP", 64,64,64);
            dwgfx.Print(103-8, 220, "[SHIP]", 196, 196, 255 - vvvvvv::Utility::glow);
            dwgfx.Print(185-4, 220, "STATS", 64,64,64);
            dwgfx.Print(258, 220, "SAVE", 64, 64, 64);

            dwgfx.Print(0, 105, "Press ACTION to warp to the ship.", 196, 196, 255 - vvvvvv::Utility::glow, true);
        }
        else if(map.custommode){
          dwgfx.Print(30, 220, "MAP", 64,64,64);
            dwgfx.Print(103-8, 220, "[CREW]", 196, 196, 255 - vvvvvv::Utility::glow);
            dwgfx.Print(185-4, 220, "STATS", 64,64,64);
            dwgfx.Print(258, 220, "SAVE", 64, 64, 64);

            if (dwgfx.flipmode)
            {
              dwgfx.bigprint( -1, 220-45, ed.ListOfMetaData[game.playcustomlevel].title, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 220-70, "by " + ed.ListOfMetaData[game.playcustomlevel].creator, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 220-80, ed.ListOfMetaData[game.playcustomlevel].website, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 220-100, ed.ListOfMetaData[game.playcustomlevel].Desc1, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 220-110, ed.ListOfMetaData[game.playcustomlevel].Desc2, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 220-120, ed.ListOfMetaData[game.playcustomlevel].Desc3, 196, 196, 255 - vvvvvv::Utility::glow, true);

              if(map.customcrewmates-game.crewmates==1){
                dwgfx.Print(1,220-165, vvvvvv::Utility::toWord(int(map.customcrewmates-game.crewmates))+ " crewmate remains", 196, 196, 255 - vvvvvv::Utility::glow, true);
              }else if(map.customcrewmates-game.crewmates>0){
                dwgfx.Print(1,220-165, vvvvvv::Utility::toWord(int(map.customcrewmates-game.crewmates))+ " crewmates remain", 196, 196, 255 - vvvvvv::Utility::glow, true);
              }
            }
            else
            {
              dwgfx.bigprint( -1, 45, ed.ListOfMetaData[game.playcustomlevel].title, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 70, "by " + ed.ListOfMetaData[game.playcustomlevel].creator, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 80, ed.ListOfMetaData[game.playcustomlevel].website, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 100, ed.ListOfMetaData[game.playcustomlevel].Desc1, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 110, ed.ListOfMetaData[game.playcustomlevel].Desc2, 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print( -1, 120, ed.ListOfMetaData[game.playcustomlevel].Desc3, 196, 196, 255 - vvvvvv::Utility::glow, true);

              if(map.customcrewmates-game.crewmates==1){
                dwgfx.Print(1,165, vvvvvv::Utility::toWord(int(map.customcrewmates-game.crewmates))+ " crewmate remains", 196, 196, 255 - vvvvvv::Utility::glow, true);
              }else if(map.customcrewmates-game.crewmates>0){
                dwgfx.Print(1,165, vvvvvv::Utility::toWord(int(map.customcrewmates-game.crewmates))+ " crewmates remain", 196, 196, 255 - vvvvvv::Utility::glow, true);
              }
            }
        }
        else
    ...
    case 2:
        ...
        dwgfx.Print(185-12, 220, "[STATS]", 196, 196, 255 - vvvvvv::Utility::glow);
        dwgfx.Print(258, 220, "SAVE", 64, 64, 64);

        if(map.custommode){
          if (dwgfx.flipmode)
          {
              dwgfx.Print(0, 164, "[Trinkets found]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 152, vvvvvv::Utility::toWord(game.trinkets) + " out of " + vvvvvv::Utility::toWord(map.customtrinkets), 96,96,96, true);

              dwgfx.Print(0, 114, "[Number of Deaths]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 102,vvvvvv::Utility::toString(game.deathcounts),  96,96,96, true);

              dwgfx.Print(0, 64, "[Time Taken]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 52, game.timestring(),  96, 96, 96, true);
          }
          else
          {
              dwgfx.Print(0, 52, "[Trinkets found]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 64, vvvvvv::Utility::toWord(game.trinkets) + " out of "+vvvvvv::Utility::toWord(map.customtrinkets), 96,96,96, true);

              dwgfx.Print(0, 102, "[Number of Deaths]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 114,vvvvvv::Utility::toString(game.deathcounts),  96,96,96, true);

              dwgfx.Print(0, 152, "[Time Taken]", 196, 196, 255 - vvvvvv::Utility::glow, true);
          ...
          {
              dwgfx.Print(0, 164, "[Trinkets found]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 152, vvvvvv::Utility::toWord(game.trinkets) + " out of Twenty", 96,96,96, true);
          ...
          {
              dwgfx.Print(0, 52, "[Trinkets found]", 196, 196, 255 - vvvvvv::Utility::glow, true);
              dwgfx.Print(0, 64, vvvvvv::Utility::toWord(game.trinkets) + " out of Twenty", 96,96,96, true);
    ...
    case 3:
        ...
        dwgfx.Print(185-4, 220, "STATS", 64,64,64);
        dwgfx.Print(258 - 8, 220, "[SAVE]", 196, 196, 255 - vvvvvv::Utility::glow);
        ...
        else if (map.custommode)
        {
          if (game.gamesaved)
            {
                dwgfx.Print(0, 36, "Game saved ok!", 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);

                dwgfx.drawpixeltextbox(25, 65, 270, 90, 34,12, 65, 185, 207,0,4);

                if (dwgfx.flipmode)
                {
                    dwgfx.Print(0, 122, game.customleveltitle, 25, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);
                    dwgfx.Print(160 - 84, 78, game.savetime, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
                    dwgfx.Print(160 + 40, 78, vvvvvv::Utility::toWord(game.savetrinkets), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
                ...
                {
                    dwgfx.Print(0, 90, game.customleveltitle, 25, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);
                    dwgfx.Print(160 - 84, 132, game.savetime, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
                    dwgfx.Print(160 + 40, 132, vvvvvv::Utility::toWord(game.savetrinkets), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2));
            ...
            {
                dwgfx.Print(0, 80, "[Press ACTION to save your game]", 255 - (vvvvvv::Utility::glow * 2), 255 - (vvvvvv::Utility::glow * 2), 255 - vvvvvv::Utility::glow, true);
            }
        }
        else
        {
            ...
            if (game.gamesaved)
            {
                ...
                if (dwgfx.flipmode)
                {
                    dwgfx.Print(0, 132, game.savearea, 25, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);
                    for (int i = 0; i < 6; i++)
                    {
                ...
                {
                    dwgfx.Print(0, 80, game.savearea, 25, 255 - (vvvvvv::Utility::glow / 2), 255 - (vvvvvv::Utility::glow / 2), true);
                    for (int i = 0; i < 6; i++)
                    {
            ...
            else
            {
                ...
                if (game.quicksummary != "")
                {
                    if (dwgfx.flipmode)
                    {
                        dwgfx.Print(0, 110, "Last Save:", 164 - (vvvvvv::Utility::glow / 4), 164 - (vvvvvv::Utility::glow / 4), 164, true);
                        dwgfx.Print(0, 100, game.quicksummary, 164  - (vvvvvv::Utility::glow / 4), 164 - (vvvvvv::Utility::glow / 4), 164, true);
                    }
                    else
                    {
                        dwgfx.Print(0, 100, "Last Save:", 164 - (vvvvvv::Utility::glow / 4), 164 - (vvvvvv::Utility::glow / 4), 164, true);
                        dwgfx.Print(0, 110, game.quicksummary, 164  - (vvvvvv::Utility::glow / 4), 164 - (vvvvvv::Utility::glow / 4), 164, true);
                    }
                }
            }
        }
        break;
    case 10:
        dwgfx.Print(128, 220, "[ QUIT ]", 196, 196, 255 - vvvvvv::Utility::glow);

        if (dwgfx.flipmode)
        {
            if (game.intimetrial || game.insecretlab || game.nodeathmode || game.menukludge)
            {
                dwgfx.Print(0, 135, "Return to main menu?", 196, 196, 255 - vvvvvv::Utility::glow, true);
            }
            else
            {
                dwgfx.Print(0, 142, "Do you want to quit? You will", 196, 196, 255 - vvvvvv::Utility::glow, true);
                dwgfx.Print(0, 130, "lose any unsaved progress.", 196, 196, 255 - vvvvvv::Utility::glow, true);
            }

            dwgfx.Print(80-16, 88, "[ NO, KEEP PLAYING ]", 196, 196, 255 - vvvvvv::Utility::glow);
        ...
        else
        {
            ...
            if (game.intimetrial || game.insecretlab || game.nodeathmode || game.menukludge)
            {
                dwgfx.Print(0, 80, "Return to main menu?", 196, 196, 255 - vvvvvv::Utility::glow, true);
            }
            else
            {
                dwgfx.Print(0, 76, "Do you want to quit? You will", 196, 196, 255 - vvvvvv::Utility::glow, true);
                dwgfx.Print(0, 88, "lose any unsaved progress.", 196, 196, 255 - vvvvvv::Utility::glow, true);
            }

            dwgfx.Print(80-16, 130, "[ NO, KEEP PLAYING ]", 196, 196, 255 - vvvvvv::Utility::glow);
    ...
    case 11:
        ...
        if (dwgfx.flipmode)
        {
            ...
            dwgfx.Print(80+32-16, 76, "[ YES, QUIT TO MENU ]",  196, 196, 255 - vvvvvv::Utility::glow);
        }
        else
        {
            if (game.intimetrial || game.insecretlab || game.nodeathmode || game.menukludge)
            ...
            dwgfx.Print(80+32-16, 142, "[ YES, QUIT TO MENU ]", 196, 196, 255 - vvvvvv::Utility::glow);
        }
        break;
    case 20:
        dwgfx.Print(128, 220, "[ GRAVITRON ]", 196, 196, 255 - vvvvvv::Utility::glow, true);

        if (dwgfx.flipmode)
        {
            dwgfx.Print(0, 76, "the secret laboratory?", 196, 196, 255 - vvvvvv::Utility::glow, true);
            dwgfx.Print(0, 88, "Do you want to return to", 196, 196, 255 - vvvvvv::Utility::glow, true);
            dwgfx.Print(80-16, 142, "[ NO, KEEP PLAYING ]", 196, 196, 255 - vvvvvv::Utility::glow);
            dwgfx.Print(80 + 32, 130, "yes, return",  96, 96, 96);
        }
        else
        {
            dwgfx.Print(0, 76, "Do you want to return to", 196, 196, 255 - vvvvvv::Utility::glow, true);
            dwgfx.Print(0, 88, "the secret laboratory?", 196, 196, 255 - vvvvvv::Utility::glow, true);
            dwgfx.Print(80-16, 130, "[ NO, KEEP PLAYING ]", 196, 196, 255 - vvvvvv::Utility::glow);
    ...
    case 21:
        ...
        if (dwgfx.flipmode)
        {
            ...
            dwgfx.Print(80 + 32-16, 130, "[ YES, RETURN ]",  196, 196, 255 - vvvvvv::Utility::glow);
        }
        else
        {
            dwgfx.Print(0, 76, "Do you want to return to", 196, 196, 255 - vvvvvv::Utility::glow, true);
            dwgfx.Print(0, 88, "the secret laboratory?", 196, 196, 255 - vvvvvv::Utility::glow, true);
            dwgfx.Print(80, 130, "no, keep playing", 96, 96, 96);
            dwgfx.Print(80 + 32-16, 142, "[ YES, RETURN ]",  196, 196, 255 - vvvvvv::Utility::glow);
        }
...
void teleporterrender(Graphics& dwgfx, Game& game, MapClass& map, EntityClass& obj)
{
    ...
    {
        //tower!instead of room y, scale map.ypos
        dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2, 21  + 2, 12 - 4, 180 - 4, 16, 245 - (vvvvvv::Utility::glow * 2), 245 - (vvvvvv::Utility::glow * 2));
    }
    else
    {
        dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2, 21 + ((game.roomy - 100) * 9) + 2, 12 - 4, 9 - 4, 16, 245 - (vvvvvv::Utility::glow * 2), 245 - (vvvvvv::Utility::glow * 2));
    }
    ...
    if (game.useteleporter)
    {
        ...
        dwgfx.drawrect(40 + (tempx * 12) + 1, 21 + (tempy * 9) + 1, 12 - 2, 9 - 2, 245 - (vvvvvv::Utility::glow * 2), 16, 16);
        dwgfx.drawrect(40 + (tempx * 12) + 3, 21 + (tempy * 9) + 3, 12 - 6, 9 - 6, 245 - (vvvvvv::Utility::glow * 2), 16, 16);
    }
    ...
    if (game.useteleporter && ((vvvvvv::Utility::slowSine%16)>8))
    {
    ...
    {
        //Instructions!
        dwgfx.Print(5, 210, "Press Left/Right to choose a Teleporter", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
        dwgfx.Print(5, 225, "Press ENTER to Teleport", 220 - (vvvvvv::Utility::glow), 220 - (vvvvvv::Utility::glow), 255 - (vvvvvv::Utility::glow / 2), true);
    }
